...
class _CreatePasswordScreenState extends State<CreatePasswordScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => getIt<CreatePasswordViewModel>(),
      child: Scaffold(
        ...
        body: Consumer<CreatePasswordViewModel>(
  ...
  Widget _buildBodyWithLoadingIndicator(
      BuildContext context, CreatePasswordViewModel model) {
    return Stack(
      children: [
  ...
  Widget _buildBody(BuildContext context, CreatePasswordViewModel model) {
    return Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (!allFieldsFilled) {
                      ...
                      final password = otpControllers.map((c) => c.text).join();
                      model.submitCreatePassword(password);
